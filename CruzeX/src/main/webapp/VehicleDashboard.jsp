...
<div class="container-fluid">
    <ul class="nav justify-content-center navbar-custom py-2">
        ...
        <li class="nav-item">
            <a class="text-white nav-link" href="BookController">
                <i class="fas fa-book me-2"></i>Book Catalog
            </a>
        </li>
        <li class="nav-item">
            <a class="link-secondary nav-link" href="Search-Book-Details.jsp">
                <i class="fas fa-search me-2"></i>Search & Update Book
            </a>
        </li>
        <li class="nav-item">
            <a class="link-secondary nav-link" href="Book?type=loadDrivers">
    ...
    <div class="container">
        <h2 class="text-center">Book Inventory Management</h2>
